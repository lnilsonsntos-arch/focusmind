...
import { Eye, EyeOff, Mail, Lock, User, AlertCircle, ArrowLeft, Loader2, Check } from 'lucide-react';
...
export function Signup() {
  ...
  const passwordRequirements = [
    { test: password.length >= 8, label: 'Minimo 8 caracteres' },
    { test: /[A-Z]/.test(password), label: 'Uma letra maiuscula' },
    { test: /[a-z]/.test(password), label: 'Uma letra minuscula' },
    { test: /[0-9]/.test(password), label: 'Um numero' },
  ];
          ...
          {success ? (
            <div className="p-6 bg-green-50 border border-green-200 rounded-xl text-center">
              ...
              <p className="text-green-700 text-sm mb-4">
                Voce ja pode fazer login com suas credenciais.
              </p>
              <Link
                to="/login"
                className="inline-block py-2.5 px-6 bg-gradient-to-r from-blue-900 to-purple-700 text-white rounded-xl font-medium"
              >
                Ir para login
              </Link>
            </div>
